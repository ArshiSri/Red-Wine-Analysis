...
wine <- read.csv("C:\\Users\\DELL\\Projects\\wineQualityReds.csv")
...
ggplot(data = wine, aes(x = citric.acid)) +
  geom_histogram(binwidth = 0.08, color = 'white',fill = I('black')) +
...
ggplot(data = wine, aes(x = total.sulfur.dioxide)) +
  geom_histogram(binwidth = 5, color = 'white',fill = I('black')) +
...
ggplot(data = wine, aes(x = density)) +
  geom_histogram(binwidth = 0.001, color = 'black',fill = I('yellow')), ncol = 2)
